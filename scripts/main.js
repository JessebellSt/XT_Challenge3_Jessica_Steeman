...
var landingSpots = [
	{
		...
		location: {lat: 28.5728722,lng: -80.6511695},
        ranking: 2
	}, {
		name: 'Green Swamp',
		location: {lat: 28.4361811, lng: -81.96394183},
        ranking: 5
	}, {
		name: 'Everglades',
		location: {lat: 25.97087439,lng: -81.08866618},
        ranking: 0
	}, {
		name: 'Lake Okeechobee',
		location: {lat: 26.94475043, lng: -80.9055606},
        ranking: 4
	}, {
		name: 'Ocala',
		location: {lat: 29.06706271, lng: -81.74421526},
        ranking: 3
	}
];
...
function initMap() {
    ...
    myMap.addListener('center_changed', function() {
        ...
        window.setTimeout(function() {
            myMap.panTo(landingSpots.getPosition());
        }, 3000);
    });
...
function addSpot(spot){
	new google.maps.Marker({
		...
		map: myMap,
		title: spot.name,
		icon: icons[spot.ranking]
	});
    
	console.log(spot.name + ' added to map');
